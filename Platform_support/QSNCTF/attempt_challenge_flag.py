...
def attempt_challenge_flag(challenges_id, flag, cookies):
    ...
    burp0_url = "https://www.qsnctf.com/api/v1/challenges/attempt"
    burp0_cookies = cookies
    ...
    burp0_json = {"challenge_id": f"{challenges_id}", "submission": f"{flag}"}
    response = requests.post(burp0_url, headers=burp0_headers, cookies=burp0_cookies, json=burp0_json).json()
...
print(attempt_challenge_flag(368, "n1book{union_select_is_so_cool}", get_qsnctf_session()))
