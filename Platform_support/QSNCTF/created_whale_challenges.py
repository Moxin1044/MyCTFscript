...
def created_whale_challenges(challenges_id, cookies):
    ...
    burp0_url = f"https://www.qsnctf.com/api/v1/plugins/ctfd-whale/container?challenge_id={challenges_id}"
    burp0_cookies = cookies
...
print(created_whale_challenges(261, get_qsnctf_session()))
