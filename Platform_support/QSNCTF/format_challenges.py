...
def get_login_user_info(cookies):
    ...
    if response['success']:
        ...
        for challenge in response['data']:
            challenge_list.append({"id": challenge['id'], "type": challenge['type'], "name": challenge['name'], "value": challenge['value'], "solves": challenge['solves'], "category": challenge['category']})
