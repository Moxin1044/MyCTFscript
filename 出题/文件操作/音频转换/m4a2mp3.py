...
def main():
    parser = argparse.ArgumentParser(description='M4A转MP3转换器')
    ...
    if os.path.isfile(args.input):
        convert_m4a_to_mp3(args.input, os.path.join(args.output, f"{os.path.splitext(os.path.basename(args.input))[0]}.mp3"))
    else:
